...
$routes->get('/user/transaksi', 'Transaksi::index');
...
$routes->post('/user/transaksi/simpan', 'Transaksi::simpan');
$routes->post('/user/transaksi/detail', 'Transaksi::detail');
$routes->post('/user/transaksi/detail/cetak', 'Transaksi::cetakToPDF');
// $routes->get('/user/transaksi/simpan', 'Transaksi::simpan');
