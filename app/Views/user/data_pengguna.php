          ...
          <div class="modal-body">
            <form id="tambahPenggunaForm" action="" method="post" enctype="multipart/form-data">
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="nama" name="nama" placeholder="Masukkan Nama Marketing">
              ...
              <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <div class="invalid-feedback" id="invalidTglLahir">sasasasas</div>
                </div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input type="password" class="form-control" id="repeatpassword" name="repeatpassword" placeholder="Ulangi Password">
          ...
          <div class="modal-body">
            <form id="editPenggunaForm" action="" method="post" enctype="multipart/form-data">
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="namaEdit" name="namaEdit" placeholder="Masukkan nama pengguna">
              ...
              <div class="form-group">
                ...
                <input type="password" class="form-control" id="passwordEdit" name="passwordEdit" placeholder="Masukkan Password">
                <div class="invalid-feedback" id="invalidPasswordEdit"></div>
              </div>
              <div class="form-group">
                <label for="repeatPasswordEdit">Ulangi Password</label>
                <input type="password" class="form-control" id="repeatPasswordEdit" name="repeatPasswordEdit" placeholder="Ulangi Password">
